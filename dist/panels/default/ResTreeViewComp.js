...
exports.ResTreeViewComp = void 0;
const fs_extra_1 = require("fs-extra");
const path_1 = require("path");
exports.ResTreeViewComp = {
    template: (0, fs_extra_1.readFileSync)((0, path_1.join)(__dirname, '../../../static/template/vue/res_tree_view.html'), 'utf-8'),
    data() {
        return {};
    }, methods: {},
    mounted() {
        console.log("已挂载 ResTreeViewComp");
        // @ts-ignore
        const vm = this;
        var t = {
            detail: {

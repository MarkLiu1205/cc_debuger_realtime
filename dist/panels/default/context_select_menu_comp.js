...
exports.createContextMenu = exports.context_select_menu_comp = void 0;
...
exports.context_select_menu_comp = (0, vue_1.defineComponent)({
    ...
    setup(props, { emit }) {
        const popuMenuRef = (0, vue_1.ref)(null);
        const selectedOptions = (0, vue_1.ref)([]);
        const bSelectAll = (0, vue_1.ref)(false);
        const onToggleAll = () => {
        ...
        const handleSelection = () => {
            emit('select', props.is_muti_select ? [...selectedOptions.value] : selectedOptions.value);
        };
        const closeMenu = (e) => {
            e.stopPropagation();
...
const createContextMenu = (document, props) => {
    const container = document.createElement('div');
    document.body.appendChild(container);
    const app = (0, vue_1.createApp)({
        render() {
            return (0, vue_1.h)(exports.context_select_menu_comp, {
